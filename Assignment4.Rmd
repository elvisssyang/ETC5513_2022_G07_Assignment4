...
Apparently, our model have some bias in selecting our sample. In our report, there are `r table(map$not_included)["TRUE"]` are not included, which have been coloured in red from Figure \@ref(fig:worldmapall)
